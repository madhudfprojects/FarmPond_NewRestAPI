...
public class AddFarmerResList {
    ...
    public String getFarmPondCount() {
        return farmPondCount;
    }

    public void setFarmPondCount(String farmPondCount) {
        this.farmPondCount = farmPondCount;
    }
